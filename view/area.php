...
<body>
    <div class="container">
        ...
        <div class="search-container">
            <form method="GET" action="">
                <input type="text" id="areaSearch" name="search" placeholder="Search by Area Name or Code..." value="<?php echo htmlspecialchars($search); ?>">
        ...
        <?php if ($result && $result->num_rows > 0): ?>
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo htmlspecialchars($row['AREASNO']); ?></td>
                        <td><?php echo htmlspecialchars($row['AREANAME']); ?></td>
                        <td><?php echo htmlspecialchars($row['AREACODE']); ?></td>
                        <td class="<?php echo $row['AREAACTFLG'] == 1 ? 'status-active' : 'status-inactive'; ?>">
                            <?php echo $row['AREAACTFLG'] == 1 ? 'Active' : 'Inactive'; ?>
                        </td>
                        <td>
    ...
    <script>
    $(function() {
        // Autocomplete for area names and codes
